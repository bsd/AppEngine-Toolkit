...
class BlueStateService(remote.Service):
	...
	def __init__(self, *args, **kwargs):
		super(BlueStateService, self).__init__(*args, **kwargs)
		
	def initiate_request_state(self, state):
		super(BlueStateService, self).initiate_request_state(state)

	def _initializeBlueStateService(self):
	...
	def __repr__(self):
		return '<BlueStateService::'+'.'.join(self.__module__.split('.')+[self.__class__.__name__])+'>'
