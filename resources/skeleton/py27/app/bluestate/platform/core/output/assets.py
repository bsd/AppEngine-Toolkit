...
## Exception Imports
from bluestate.platform.core.output import AssetException
from bluestate.platform.core.output import InvalidAssetType
from bluestate.platform.core.output import InvalidAssetEntry

asset_url_cache = {}


class CoreAssetsAPI(BlueStateCoreAPI):
	...
	def _AssetConfig(self):
		...
		return config.get('bluestate.project.assets')
	...
	def _OutputConfig(self):
		...
		return config.get('bluestate.project.output')
